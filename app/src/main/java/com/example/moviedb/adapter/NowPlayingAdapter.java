...
import com.example.moviedb.view.movieDetail;
...
public class NowPlayingAdapter extends RecyclerView.Adapter<NowPlayingAdapter.CardViewViewHolder> {
    ...
    public CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_now_playiing, parent, false);
    ...
    public class CardViewViewHolder extends RecyclerView.ViewHolder {
        ...
        public CardViewViewHolder(@NonNull View itemView) {
            super(itemView);
            img_poster = itemView.findViewById(R.id.img_poster_card_nowplayiing);
            lbl_title = itemView.findViewById(R.id.lbl_title_card_nowplayiing);
            lbl_overview = itemView.findViewById(R.id.lbl_overview_card_nowplayiing);
            lbl_release_date = itemView.findViewById(R.id.lbl_releasedate_card_nowplayiing);
            cv = itemView.findViewById(R.id.cv_card_nowplayiing);
        }
    }
}
